...
public class CheckList implements ActionListener{
	...
	JTextArea jt = new JTextArea("개인정보보호법에 따라 네이버에 회원가입 신청하시는 분께 수집하는 개인정보의 항목, 개인정보의 수집 및 이용목적, 개인정보의 보유 및 이용기간, 동의 거부권 및 동의 거부 시 불이익에 관한 사항을 안내 드리오니 자세히 읽은 후 동의하여 주시기 바랍니다.\r\n" + 
			"\r\n" + 
			"1. 수집하는 개인정보\r\n" + 
	...
	JCheckBox jc = new JCheckBox("개인정보 수집 및 이용 동의(필수)");
	Panel p1 = new Panel();
	Panel p2 = new Panel();
	...
	public void actionPerformed(ActionEvent e) {
		...
		case "확인" :
			if(jc.isSelected()==true) {
				...
				JOptionPane.showMessageDialog( null, "체크 확인");
				break;
			}
		case "취소" : 
			Login l =new Login();
